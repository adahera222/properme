...
public class UIVirtualScreen : MonoBehaviour, IUIObject
{
	...
	public virtual void Awake()
	{
		...
		if (mc != null)
			...
			ScreenLog.AddMessage("The object \"" + name + "\" does not have the required MeshCollider attached.  Please add one, or else the screen functionality will not work.", ScreenLogType.Error);
