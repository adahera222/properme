...
public class SpriteText : MonoBehaviour, IUseCamera 
{
	...
	protected virtual void Init ()
	{
		...
		if (texture == null && Application.isPlaying)
			ScreenLog.AddMessage("Text on GameObject \"" + name + "\" has not been assigned either a texture or a material.", ScreenLogType.Warning);
#endif
		...
		if (font != null)
		{
			...
			if (spriteFont == null)
				ScreenLog.AddMessage("Warning: " + name + " was unable to load font \"" + font.name + "\"!", ScreenLogType.Warning);
		}
		else if(Application.isPlaying)
			ScreenLog.AddMessage("Warning: " + name + " currently has no font assigned.", ScreenLogType.Warning);
