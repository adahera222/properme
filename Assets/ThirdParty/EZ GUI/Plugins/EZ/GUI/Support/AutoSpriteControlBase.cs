	...
	public virtual string Text
	{
		...
		set
		{
			...
			if(spriteText == null)
			{
				...
				{
					ScreenLog.AddMessage("Warning: No UIManager exists in the scene. A UIManager with a default font is required to automatically add text to a control.", ScreenLogType.Warning);
					return;
				}
				else if(UIManager.instance.defaultFont == null)
				{
					ScreenLog.AddMessage("Warning: No default font defined.  A UIManager object with a default font is required to automatically add text to a control.", ScreenLogType.Warning);
					return;
				}
